/**
 * ⚠️ DEPRECATED: Legacy chat endpoint v3
 * 
 * CANONICAL ENDPOINT: netlify/functions/chat.ts
 * 
 * This file is kept for reference only. All chat functionality has been consolidated
 * into netlify/functions/chat.ts which provides:
 * - Guardrails and PII masking
 * - Employee routing (Prime / "prime-boss")
 * - Long-term memory via memory table and match_memory_embeddings
 * - Streaming responses
 ...
 * - Handoff support
 * 
 * DO NOT USE THIS ENDPOINT. Use /.netlify/functions/chat instead.
 * 
 * This file will be removed in a future cleanup.
 * 
 * Phase 1.3: Consolidated November 20, 2025
 */
