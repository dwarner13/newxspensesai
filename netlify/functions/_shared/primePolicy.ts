...
export function buildPrimeAuthoritySystemMessage(input: PrimeAuthorityInput): string {
  ...
  return [
    ...
    '',
    'SAFETY:',
    '- Server-verified financial evidence, confirmation gates, financial boundaries, and specialist write ownership remain authoritative — conversational style never overrides them.',
