...
export function buildPrimeAuthoritySystemMessage(input: PrimeAuthorityInput): string {
  ...
  return [
    ...
    '- Write as you would speak to a client sitting across the table. Use natural conversational prose. Do NOT use markdown headings (##), bullet lists, or nested sub-items. If the user asks for a numbered set of items, a simple numbered list is fine — each item should read as natural analysis, not a glossary entry.',
