...
export const EMPLOYEE_DISPLAY_CONFIG: Record<string, EmployeeDisplayConfig> = {
  ...
  'debt-payoff-planner': {
    ...
    accentGlow: 'bg-orange-500/10',
    accentShadow: 'shadow-[0_0_40px_rgba(251,146,60,0.7)]',
    accentColor: 'orange-500',
    primaryButtonGradient: 'from-yellow-400 via-orange-500 to-red-500',
    primaryButtonShadow: 'shadow-orange-900/60',
    stats: [
      { value: '$12,450', label: 'Total Debt', colorClass: 'text-orange-400' },
  ...
  'tax-assistant': {
    ...
    primaryButtonGradient: 'from-blue-400 via-indigo-400 to-purple-400',
    primaryButtonShadow: 'shadow-blue-900/60',
    stats: [
      { value: '$4,250', label: 'Deductions Found', colorClass: 'text-green-400' },
    ...
    chatQuickPrompts: [
      ...
      'Show me my tax savings opportunities.',
      'Guide me through tax preparation.',
    ],
  },
