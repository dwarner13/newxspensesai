...
const PLANS = [
  {
    ...
    features: ["3 statements per month", "Basic categorization by Tag", "Xspense Score (limited)", "Prime chat (10 messages/day)", "Monthly written recap"],
    cta: "Get Started Free",
  },
  {
    name: "Pro", price: "$29.99", annualPrice: "$23.99", period: "/month", desc: "The full AI experience",
    color: C.accent, highlight: true,
    features: ["Unlimited statements & OCR", "Full AI categorization + learning", "Complete Xspense Score (all 28 factors)", "Unlimited Prime chat + all 6 copilots", "Tax deduction organizer (Ledger)", "Goals & debt coaching (Goalie)", "Branded PDF reports + accountant packages", "Audio recaps", "Priority processing"],
    cta: "Start Pro Free Trial",
  },
  {
    name: "Business", price: "$49.99", annualPrice: "$39.99", period: "/month", desc: "For freelancers & small business",
      ...
      <section style={{ padding: isMobile ? "120px 20px 60px" : "140px 48px 100px", textAlign: "center" }}>
        ...
        <div style={{
          ...
          {PLANS.map((plan, i) => {
            ...
            return (
              <MarketingReveal key={plan.name} delay={i * 100} style={{ flex: isMobile ? undefined : 1 }}>
                <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 8 }}>
                    <span style={{ fontSize: isMobile ? 36 : 44, fontWeight: 800, color: C.text }}>{displayPrice}</span>
                  ...
                  <div style={{ flex: 1 }}>
                    {plan.features.map(f => (
                      <div key={f} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                        ...
                        <span style={{ fontSize: isMobile ? 13 : 14, color: C.textMuted }}>{f}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <a href="/login" style={{
                    ...
                    padding: "14px 24px", borderRadius: 12, marginTop: 24,
