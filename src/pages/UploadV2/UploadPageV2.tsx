...
export default function UploadPageV2() {
  ...
  const byteStatus = stats.processing > 0 ? `Processing ${stats.complete + 1} of ${stats.total}...` : stats.total === 0 ? "Idle — waiting for files" : allDone ? (hasHeld ? `${stats.held} needs review` : "All done!") : "Ready";
