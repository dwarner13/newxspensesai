 ...
 * BI Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with BI, 
 * one of the AI employees. The chat sends your messages to the server,
 * and BI responds with helpful information.
 */
export default function BIChat() {
  ...
  // and manages messages. We pass 'intelia' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('intelia:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('intelia:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">BI</h1>
