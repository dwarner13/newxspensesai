 ...
 * Wellness Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Wellness, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Wellness responds with helpful information.
 */
export default function WellnessChat() {
  ...
  // and manages messages. We pass 'harmony' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('harmony:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('harmony:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Wellness</h1>
