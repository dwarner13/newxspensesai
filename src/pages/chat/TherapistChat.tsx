 ...
 * Therapist Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Therapist, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Therapist responds with helpful information.
 */
export default function TherapistChat() {
  ...
  // and manages messages. We pass 'serenity' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('serenity:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('serenity:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Therapist</h1>
