 ...
 * Spotify Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Spotify, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Spotify responds with helpful information.
 */
export default function SpotifyChat() {
  ...
  // and manages messages. We pass 'wave' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('wave:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('wave:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Spotify</h1>
