...
/**
 * Automation Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Automation, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Automation responds with helpful information.
 */
export default function AutomationChat() {
  ...
  // and manages messages. We pass 'automa' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('automa:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('automa:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Automation</h1>
