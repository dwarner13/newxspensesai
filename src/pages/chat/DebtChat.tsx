 ...
 * Debt Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Debt, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Debt responds with helpful information.
 */
export default function DebtChat() {
  ...
  // and manages messages. We pass 'blitz' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('blitz:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('blitz:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Debt</h1>
