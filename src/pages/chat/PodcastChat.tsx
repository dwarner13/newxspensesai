 ...
 * Podcast Chat Page
 * 
 * Grade 4 explanation: This page lets you chat with Podcast, 
 * one of the AI employees. The chat sends your messages to the server,
 * and Podcast responds with helpful information.
 */
export default function PodcastChat() {
  ...
  // and manages messages. We pass 'roundtable' to tell it which employee to use.
  ...
  useEffect(() => {
    const payload = localStorage.getItem('roundtable:payload');
    if (payload) {
      try {
        ...
        if (data && typeof data === 'object') {
          ...
          localStorage.removeItem('roundtable:payload');
        }
      } catch (e) {
        // Ignore parse errors
      }
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-xl font-semibold mb-4">Podcast</h1>
