    ...
    <>
      ...
      {!copilotOpen && (
        <button onClick={() => setCopilotOpen(true)} aria-label="Open Tag Copilot"
          ...
          style={{ bottom: 24, right: 24, width: 52, height: 52, borderRadius: "50%", background: `linear-gradient(135deg, ${CYAN}, #0891b2)`, boxShadow: `0 4px 20px ${CYAN}44`, display: "flex", alignItems: "center", justifyContent: "center", border: "none", cursor: "pointer", fontSize: 18, fontWeight: 700, color: "#0b1220" }}
        >T</button>
      )}
