...
export default function CategoriesPageV2() {
  ...
  const overBudgetCount = data.categories.filter(c => c.budget > 0 && c.spent > c.budget).length;
  ...
  return (
    <>
      ...
      <div style={{
          ...
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", justifyContent: "space-between", alignItems: isMobile ? "flex-start" : "flex-start", marginBottom: 24, gap: isMobile ? 12 : 0 }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              <button onClick={() => setCopilotOpen(true)} style={{
                display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", fontSize: 12, fontWeight: 700,
                background: `${CYAN}12`, border: `1px solid ${CYAN}28`, borderRadius: 10,
              ...
              >
                <span style={{
                  ...
                  background: `${CYAN}25`, border: `1px solid ${CYAN}44`, color: CYAN,
                  display: "inline-flex", alignItems: "center", justifyContent: "center",
                }}>T</span>
                Tag Copilot
              </button>
              <button onClick={() => toast("Budget setting coming soon")} style={{
                display: "flex", alignItems: "center", gap: 6, padding: "8px 16px", fontSize: 12, fontWeight: 700,
                background: `linear-gradient(135deg, ${THEME.accent}, #a08030)`, border: "none", borderRadius: 10,
                color: "#0b1220", cursor: "pointer", transition: "all 0.15s",
                boxShadow: `0 4px 16px rgba(200,166,78,0.35)`,
              }}>+ Set Budget</button>
            </div>
          </div>
        </Reveal>
        ...
        {/* Tag copilot insight strip (clickable) */}
        <Reveal delay={150}>
          <button
            type="button"
            ...
            style={{
              ...
              background: `${CYAN}04`, border: `1px solid ${CYAN}18`,
          ...
          >
            <div style={{
              ...
              fontSize: 11, fontWeight: 700, color: CYAN, boxShadow: `0 0 12px ${CYAN}25`,
            }}>T</div>
      ...
      {/* Tag floating bubble (only when copilot is closed) */}
      {!copilotOpen && (
        <button
          onClick={() => setCopilotOpen(true)}
          ...
          style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            border: "none", cursor: "pointer", fontSize: 18, fontWeight: 700, color: "#0b1220",
          }}
        >T</button>
      )}
