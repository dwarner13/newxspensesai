  ...
  <section className="homepage-hero bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white py-24">
    <div className="container max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-16 items-center">
      ...
      <div className="flex-1 flex justify-center mt-10 md:mt-0">
        <div className="w-full max-w-[480px] h-64 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl shadow-lg flex items-center justify-center">
          <div className="text-center text-white">
            <div className="text-4xl mb-2">🎧</div>
            <p className="text-lg font-semibold">AI Financial Podcast</p>
            <p className="text-sm opacity-80">Personal Finance Entertainment</p>
          </div>
        </div>
      </div>
    </div>
