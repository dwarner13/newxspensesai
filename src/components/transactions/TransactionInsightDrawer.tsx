...
export function TransactionInsightDrawer({
  ...
  const amountPrefix = isIncomeTx ? '+' : 'âˆ’';
          ...
          <div className="min-h-0 flex-1 space-y-6 overflow-y-auto px-6 py-6">
            ...
            <div style={{ padding: "12px 14px", borderRadius: 12, background: "rgba(34,211,238,0.04)", border: "1px solid rgba(34,211,238,0.12)", display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: "#7a8fa6", lineHeight: 1.5 }}>Have a receipt? Snap a photo and send it to Byte in chat â€” he will match it to this transaction automatically.</div>
              </div>
            </div>
            ...
            {merchantHasMapHint ? (
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">Location preview â€” full maps integration soon.</p>
              </div>
            ) : null}
