...
export default function SimpleNavigation() {
  ...
  return (
    <header className="marketing-nav bg-black/80 backdrop-blur-md fixed top-0 left-0 right-0 z-[60] border-b border-white/10" style={{paddingRight: 'var(--scrollbar-width, 0px)'}}>
