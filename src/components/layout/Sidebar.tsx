/**
 * @deprecated Use src/components/navigation/DesktopSidebar.tsx instead
 * This component is deprecated and will be removed in a future version.
 * The new DesktopSidebar uses NAV_ITEMS from nav-registry.tsx as single source of truth.
 */
...
export default function Sidebar({ 
  ...
  if (!location.pathname.startsWith('/dashboard')) {
    console.log('🚫 Sidebar: Not on dashboard route, returning null');
    return null; // Hide sidebar on ALL non-dashboard routes
  }
  
  console.log('✅ Sidebar: Rendering on dashboard route', { 
    isMobileOpen, 
    location: location.pathname,
    isMobileContext: isMobileOpen ? 'MOBILE' : 'DESKTOP'
  });
        ...
        <ul className="space-y-1 mb-4">
          ...
          <li>
            ...
            >
              ...
              {shouldShowLabels && <span className="font-medium text-white/90">Team Room</span>}
            </NavLink>
          </li>
          <li>
            <NavLink 
