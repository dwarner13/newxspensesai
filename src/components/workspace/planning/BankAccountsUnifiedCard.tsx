...
import { Plus, RefreshCw, Settings, Send, Building } from 'lucide-react';
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
      <div className="bg-gradient-to-br from-emerald-900/40 to-slate-900/10 border-b border-slate-800 pb-6 flex-shrink-0 -mx-6 -mt-6 px-6 pt-6">
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold text-white leading-tight">
              Bank Accounts — Connected Hub
            </h2>
            <p className="text-sm text-slate-400 mt-1">
              Secure bank connections · Real-time balance tracking
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex-1 flex flex-col items-center text-center">
            ...
            <div className="text-xs text-slate-500">Connected Accounts</div>
          </div>
          <div className="flex-1 flex flex-col items-center text-center">
            <div className="text-2xl font-bold text-green-400">$24,580</div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="whitespace-nowrap">Sync All</span>
          </Button>
          <Button 
            variant="secondary" 
            size="default"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Welcome to Bank Accounts</h3>
          <p className="text-slate-400 mb-4 max-w-md">
            Connect and manage all your bank accounts in one secure place. Track balances and transactions in real-time.
          </p>
        </div>
      </div>
