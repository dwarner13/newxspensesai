...
import { Sparkles, Heart, Headphones, Send } from 'lucide-react';
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
      <div className="bg-gradient-to-br from-teal-900/40 to-slate-900/10 border-b border-slate-800 pb-6 flex-shrink-0 -mx-6 -mt-6 px-6 pt-6">
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold text-white leading-tight">
              Wellness — Financial Self-Care
            </h2>
            <p className="text-sm text-slate-400 mt-1">
              Balance your financial health with mindful practices
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-3">
          ...
          <div className="flex-1 flex flex-col items-center text-center">
            ...
            <div className="text-xs text-slate-500">Activities Done</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="whitespace-nowrap">Track Mood</span>
          </Button>
          <Button 
            variant="secondary" 
            size="default"
            ...
            className="flex-1 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-teal-500/30 text-white text-xs sm:text-sm"
          >
            <Headphones className="w-4 h-4 mr-1 sm:mr-2 flex-shrink-0" />
            <span className="whitespace-nowrap">Meditations</span>
          </Button>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Welcome to Wellness Studio</h3>
          <p className="text-slate-400 mb-4 max-w-md">
            Balance your financial health with mindful practices. Take care of your money mind.
          </p>
        </div>
      </div>
      ...
      <div className="flex-shrink-0 -mx-6 px-6">
        ...
        >
          <input
            type="text"
            placeholder="Ask about financial wellness…"
            value={inputValue}
