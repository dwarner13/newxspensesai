...
import { Plus, Clock, Share2, Send, BookOpen } from 'lucide-react';
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
        ...
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-bold text-white leading-tight">
              Financial Story — Your Money Journey
            </h2>
            <p className="text-sm text-slate-400 mt-1">
              Turn your financial data into meaningful narratives
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Welcome to Financial Story</h3>
          <p className="text-slate-400 mb-4 max-w-md">
            Transform your financial journey into a compelling narrative. See your money story come to life.
          </p>
        </div>
      </div>
      ...
      <div className="flex-shrink-0 -mx-6 px-6">
        ...
        >
          <input
            type="text"
            placeholder="Ask about your financial story…"
            value={inputValue}
