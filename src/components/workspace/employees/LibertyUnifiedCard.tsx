...
import { Flag, DollarSign, TrendingUp, Send } from 'lucide-react';
      ...
      <div className="bg-gradient-to-br from-rose-900/40 to-slate-900/10 border-b border-slate-800 pb-6 flex-shrink-0 -mx-6 -mt-6 px-6 pt-6">
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex-1 flex flex-col items-center text-center">
            <div className="text-2xl font-bold text-rose-400">87%</div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Flag className="w-4 h-4 mr-1 sm:mr-2 flex-shrink-0" />
          ...
          >
            ...
            <span className="truncate">Quick Wins</span>
          </Button>
        </div>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <p className="text-slate-400 mb-4 max-w-md">
            I'm Liberty, your financial freedom specialist. Click the chat button below to break free from debt.
          </p>
        </div>
      </div>
