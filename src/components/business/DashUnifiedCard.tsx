...
import { FileText, Lightbulb, BarChart3, Send, Brain } from 'lucide-react';
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
      <div className="bg-gradient-to-br from-indigo-900/40 to-slate-900/10 border-b border-slate-800 pb-6 flex-shrink-0 -mx-6 -mt-6 px-6 pt-6">
        <div className="flex items-start gap-4 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Strategic insights engine · Transform data into business decisions
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex-1 flex flex-col items-center text-center">
            <div className="text-2xl font-bold text-indigo-400">48</div>
          ...
          <div className="flex-1 flex flex-col items-center text-center">
            ...
            <div className="text-xs text-slate-500">KPIs Tracked</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <Button 
            ...
            className="flex-1 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-indigo-500/30 text-white text-xs sm:text-sm"
          >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <p className="text-slate-400 mb-4 max-w-md">
            Transform your business data into strategic insights. I'll help you make data-driven decisions.
          </p>
        </div>
      </div>
      ...
      <div className="flex-shrink-0 -mx-6 px-6">
        ...
        >
          <input
            type="text"
            placeholder="Ask Dash about business insights…"
            value={inputValue}
