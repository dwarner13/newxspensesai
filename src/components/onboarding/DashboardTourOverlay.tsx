...
const STEPS = [
  ...
  { title: '\u265B Prime \u2014 Your Financial Advisor', body: 'The gold bubble is Prime. Tap it anytime to get a briefing on your finances, ask financial questions, or upload a statement directly in chat. He coordinates the whole team.' },
