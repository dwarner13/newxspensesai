/**
 * SettingsUnifiedCard Component
 * 
 * Unified card for Settings workspace
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Welcome to Settings</h3>
          <p className="text-slate-400 mb-4 max-w-md">
            Manage your account, customize preferences, and secure your data. Everything you need in one place.
          </p>
        </div>
      </div>
