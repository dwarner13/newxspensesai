...
export function PrimeGreetingCard({ greeting, onChipClick, className = '' }: PrimeGreetingCardProps) {
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-800/90 to-slate-900/95 backdrop-blur-xl border border-amber-500/20 rounded-2xl p-5 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_0_1px_rgba(251,191,36,0.1),inset_0_1px_0_rgba(255,255,255,0.1)]">
        {/* Subtle glow effect */}
