 ...
 * 
 * Unified card for Analytics workspace
 * Matches ByteUnifiedCard structure exactly
 */

import React, { useState, useCallback } from 'react';
import { FileText, BarChart3, Download, Send, LineChart } from 'lucide-react';
...
export function AnalyticsUnifiedCard({ onExpandClick, onChatInputClick }: AnalyticsUnifiedCardProps) {
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col h-full">
      <div className="bg-gradient-to-br from-cyan-900/40 to-slate-900/10 border-b border-slate-800 pb-6 flex-shrink-0 -mx-6 -mt-6 px-6 pt-6">
        <div className="flex items-start gap-4 mb-3">
          <div className="w-16 h-16 bg-cyan-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/50 flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Powerful financial analytics · Visualize and understand your money
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex-1 flex flex-col items-center text-center">
            <div className="text-2xl font-bold text-cyan-400">2,456</div>
          ...
          <div className="flex-1 flex flex-col items-center text-center">
            ...
            <div className="text-xs text-slate-500">Charts Created</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <Button 
            ...
            className="flex-1 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-cyan-500/30 text-white text-xs sm:text-sm"
          >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto -mx-6 px-6 py-4">
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <p className="text-slate-400 mb-4 max-w-md">
            Transform your financial data into powerful insights. Visualize trends and make informed decisions.
          </p>
        </div>
      </div>
      ...
      <div className="flex-shrink-0 -mx-6 px-6">
        <div 
          className="flex items-center gap-3 bg-slate-800 rounded-xl px-3 py-2 border border-slate-700 focus-within:border-cyan-500 transition-all duration-200 cursor-pointer"
        ...
        >
          ...
          <button
            onClick={handleSend}
            className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center shadow-lg shadow-cyan-500/30 hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
