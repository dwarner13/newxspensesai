/*
  # Fix add_user_xp function return type

  1. Changes
    - Drop existing add_user_xp function
    - Recreate add_user_xp function with JSONB return type
    - Recreate all other functions and triggers from the original migration
  
  2. Security
    - Maintain SECURITY DEFINER setting
    - Preserve all existing triggers
*/
