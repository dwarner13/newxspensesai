/*
  # Create XP system tables and functions

  1. New Tables
    - `xp_activities` - Logs XP earning activities
    - `badges` - Stores user badges and achievements
    - `weekly_goals` - Tracks weekly goals and progress
  ...
  3. Functions
    ...
    - `update_weekly_progress` - Updates weekly goal progress
*/
